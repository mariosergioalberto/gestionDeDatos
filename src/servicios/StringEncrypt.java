...
/**
 * @version 1.0 Clase que contiene los métodos encrypt y descrypt, cuyos
 * objetivos son encriptar y desencriptar respectivamente, utilizando los
 * algoritmos y codificación definidas en las variables estáticas alg y cI.
 * Requiere la librería Apache Commons Codec
 * @see <a href="http://commons.apache.org/proper/commons-codec/">Apache Commons
 * Codec</a>
 * @see
 * <a href="http://docs.oracle.com/javase/8/docs/api/javax/crypto/Cipher.html">javax.crypto
 * Class Cipher</a>
 * @see
 ...
 * Criptografía</a>
 * @see
 * <a href="http://es.wikipedia.org/wiki/Vector_de_inicializaci%C3%B3n">WikiES:
 * Vector de inicialización</a>
 * @see <a href="http://es.wikipedia.org/wiki/Cifrado_por_bloques">WikiES:
 * Cifrado por bloques</a>
